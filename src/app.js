...
class App {
    ...
    _goToCutScene() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._setUpGame().then(res => {
    ...
    _setUpGame() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // 加载环境和角色资源
            yield this._environment.load(); // 环境
            yield this._loadCharacterAssets(scene); // 角色
        });
    }
    _loadCharacterAssets(scene) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _goToGame() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // 原始文字与背景
            yield this._initializeGameAsync(scene);
            // --当场景完成加载时--
            yield scene.whenReadyAsync();
